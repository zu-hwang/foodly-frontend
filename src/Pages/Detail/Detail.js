            ...
            <div className="dish-box">
              <div className="ingredients-box">
                <ul className="ingredients-ul">
                  ...
                  <li className="ingredients-li">3/4 pound raw, peeled, deveined shrimp (medium sized)</li>
                  ...
                  <li className="ingredients-li">3 Tbsp olive oil (divided, 1 Tbsp and 2 Tbsp)</li>
                  <li className="ingredients-li">Salt and freshly ground black pepper to taste</li>
                </ul>
              </div>
              <div className="directions-box">
                1 <p className="directions-text"> Fill a large pot with 2 quarts of water. Bring to a boil (You will be using this water to both blanch the tomatoes and boil the pasta.) Core the tomatoes and use a sharp knife to cut a small X into the bottom end of each tomato. When the water is boiling, use a slotted spoon to lower the tomatoes into the water. Blanch for no more than one minute, just enough to loosen the skins. Remove tomatoes with a slotted spoon to a bowl of icy water, saving the blanching water.</p>
                2 <p className="directions-text"> Peel off the tomato skins from the tomatoes. Cut the tomatoes crosswise in half, and squeeze out most of the seeds and juices. Chop the tomatoes into 1-inch pieces.</p>
                3 <p className="directions-text"> Heat 1 Tbsp of olive oil in a large sauté pan on medium high heat. Add the shrimp to the pan and cook for 1 minute. Turn the shrimp over in the pan. Lower the heat to medium.</p>
                4 <p className="directions-text"> Add the garlic, cook a minute more. Add the chopped tomatoes and basil. Sprinkle with salt. Cook for a minute more and remove from heat.</p>
                5 <p className="directions-text"> Add a tablespoon of salt to the water you used to blanch the tomatoes. Bring to a boil again. Add the angel hair pasta and cook for 3 minutes.</p>
                6 <p className="directions-text"> Drain the pasta and immediately add to pot with the shrimp and tomatoes. Drizzle the pasta with 2 Tbsp of olive oil. Then stir the pasta in with the shrimp and tomatoes. Serve immediately or at room temp.</p>
              </div>
            </div>
          </div>
